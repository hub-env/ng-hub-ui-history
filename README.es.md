...
// Confirma un nuevo estado. Devuelve false cuando no hubo cambios.
...
| `commit(id, newState, options?)`        | `boolean`             | Confirma una nueva instantánea. Devuelve `false` cuando no hubo cambios.          |
